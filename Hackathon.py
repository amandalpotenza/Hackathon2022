...
def main():
  ...
  ##guide for each letter (a or b)
    ...
    ##guides for (e and f)
        ...
        print("Fill out the form at https://my.marist.edu/documents/810944/815970/changemajor.pdf/f05ed0eb-1516-4391-8512-8f92dffef12e and email it directly to the Chairperson or Dean of the School where the major/minor is located. They will forward this form to the registrar's office.")
        break

    ##guides for (g) 
      elif spec_input == ("g"):
        print("Every student must declare a pathway by the end of their freshman year. To complete a pathway, students take 4 courses drawn from at least 3 of the disciplinary areas.")
